...
parser.add_argument('-test-interval', type=int, default=10, help='经过多少iteration对验证集进行测试')
parser.add_argument('-early-stopping', type=int, default=100, help='早停时迭代的次数')
...
parser.add_argument('-vocab-size', type=int, default='5000', help='词典大小,会根据训练集和验证集计算出来,此处占位')
